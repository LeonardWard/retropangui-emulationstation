...
private:
    ...
    // 2026-07-22: 여전히 너무 빠르다는 피드백 - 한 번 더 늦춤.
    static constexpr double sTrigSlowestMs  = 480.0; // 세기 최소일 때 1칸당 ms
    static constexpr double sTrigFastestMs  = 110.0;  // 세기/유지시간 최대일 때
